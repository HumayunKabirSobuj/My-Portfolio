...
const Banner = () => {
    return (
        <div className="flex lg:flex-row flex-col justify-between items-center px-5 gap-5 py-10 "> 
            ...
            <div className="flex-1 space-y-5 mt-[70px]">
                ...
                <Link to="https://drive.google.com/u/0/uc?id=1579uS0XJO5ihw5kzkk4Ze-AiLG9sERQB&export=download" className="btn bg-[#f86f03] rounded-3xl ">Dawnlode CV</Link>
            </div>
